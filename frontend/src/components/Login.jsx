...
const Login = ({ onLogin, API_URL = BACKEND_URL }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!profile && token) {
        try {
          profile = fetchProfile(token);
        } catch (e) {
          console.warn("Could not fetch profile after login token : ", e);
          profile = { email };
        }
      }
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
                ...
                <div className={loginStyles.inputContainer}>
                    ...
                    className={loginStyles.input} placeholder="your@example.com" required />
                </div>
            </div>
            <div className="mb-6">
                ...
                <div className={loginStyles.inputContainer}>
                    ...
                    className={loginStyles.input} placeholder="password" required />
