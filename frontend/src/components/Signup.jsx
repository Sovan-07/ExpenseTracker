...
const Signup = ({ API_URL = BACKEND_URL, onSignup }) => {
            ...
            <div className={signupStyles.cardContainer}>
                <div className={signupStyles.header}>
                    ...
                    <p className={signupStyles.headerSubtitle}>
                        Join Expense Tracker to manage your finance
                    </p>
                </div>
                <div className={signupStyles.formContainer}>
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                        <div className="mb-6">
                            <label htmlFor="name" className={signupStyles.inputContainer}>
                                Full Name
                            </label>
                        ...
                        <div className="mb-6">
                            <label htmlFor="email" className={signupStyles.inputContainer}>
                               Email Address
                            </label>
                            <div className={signupStyles.inputContainer}>
                                <div className={signupStyles.inputIcon}>
                        ...
                        <div className="mb-6">
                            <label htmlFor="password" className={signupStyles.inputContainer}>
                                Password
                            </label>
                            <div className={signupStyles.inputContainer}>
                                <div className={signupStyles.inputIcon}>
