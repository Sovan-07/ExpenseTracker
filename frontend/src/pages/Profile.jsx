...
const Profile = ({onUpdateProfile, onLogout }) => {
  ...
  //to change password
  const handlPasswordSubmit = async (e) => {
    e.preventDefault();
    ...
    <div className={profileStyles.container}>
        ...
        <div className={profileStyles.content}>
          <div className={profileStyles.grid}>
            <div className={profileStyles.card}>
              ...
              {editMode ? (
                <div className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="email" className={profileStyles.label}>
                      Email Address
                    </label>
                    <input
                      type="email"
            ...
            <div className={profileStyles.card}>
                ...
                hover:opacity-90 transition-opacity`} disabled={loading}>
      ...
      >
        <div className={profileStyles.modalContent}>
          ...
          <form onSubmit={handlPasswordSubmit} className="space-y-4 lg:-mx-20">
            <PasswordInput
              name="current"
